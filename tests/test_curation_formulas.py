...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("spec", "gate", None, 2.0,
         ...
         0.05),
        ("hilite", "filter", 7, 2.0,
         {"frq1": 500.0, "frq2": 2000.0, "q": 100.0},
         0.05),
        ("hilite", "greq", 1, 2.0,
         {"filtfile": "gq20.txt"},
         0.05),
        ("hilite", "band", None, 2.0,
         {"banddata": "bd20.txt"},
         0.05),
        ("hilite", "pluck", None, 2.0,
         {"gain": 5.0},
         0.05),
        ("hilite", "bltr", None, 2.0,
         {"blurring": 10, "tracing": 20},
         0.05),
        ("hilite", "vowels", None, 2.0,
         {"vowelfile": "vw20.txt", "halfwidth": 0.25, "steepness": 3.0, "range": 0.95,
          "threshold": 0.5},
         0.05),
        ("specfold", "specfold", 3, 2.0,
         {"stt": 20, "len": 64, "seed": 5},
         0.05),
        ("specnu", "remove", 1, 2.0,
         {"midimin": 56.0, "midimax": 58.0, "rangetop": 4000.0, "atten": 1.0},
         0.05),
        ("specnu", "rand", None, 2.0,
         {"grouping": 4},
         0.05),
        ("specnu", "squeeze", None, 2.0,
         {"centrefrq": 500.0, "squeeze": 0.5},
         0.05),
        ("suppress", "partials", None, 2.0,
         {"timeslots": "ts20.txt", "lofrq": 300.0, "hifrq": 3000.0, "chancnt": 4},
         0.05),
        ("caltrain", "caltrain", None, 2.0,
         {"blurfact": 0.5, "blurabov": 2000.0},
         0.05),
        ("glisten", "glisten", None, 2.0,
         {"grpdiv": 4, "setdur": 30},
         0.05),
        ("newmorph", "newmorph2", 2, 2.0,
         {"peaksfile": "pk6.txt", "startmorph": 0.3, "endmorph": 1.2, "exponent": 1.0,
          "peakcnt": 6},
         0.05),
        ("selfsim", "selfsim", None, 2.0,
         {"selfsim": 3},
         0.05),
        ("superaccu", "superaccu", 1, 2.0,
         {"decay": 0.1},
         0.2),
        ("spectune", "tune", 1, 2.0,
         {},
         0.05),
        ("tunevary", "tunevary", None, 2.0,
         {"pitch_template": "ptmp1.txt"},
         0.05),
        ("specanal", "specanal", 1, 2.0,
         {"chs": 1024, "ovlp": 3},
         0.05),
